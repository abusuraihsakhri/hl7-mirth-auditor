"""
FastAPI REST API Server for Hl7 Mirth Auditor.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "hl7-mirth-auditor", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
